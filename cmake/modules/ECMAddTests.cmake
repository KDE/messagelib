...
if(NOT ECM_TEST_NAME_PREFIX_IGNORE_DIR)
    set(ECM_TEST_NAME_PREFIX_IGNORE_DIR "src" "test" "tests" "autotest" "autotests")
endif()
...
function(_ecm_test_name_prefix_from_project_path _name_prefix_varname)
    ...
    list(REMOVE_ITEM _dirs ${ECM_TEST_NAME_PREFIX_IGNORE_DIR})
...
function(ecm_test_get_name_prefix _name_prefix_varname)
    if(NOT ECM_TEST_NAME_PREFIX_STRATEGY)
        ...
        # TODO: check if known strategy set
    endif()
...
function(ecm_add_test)
  ...
  if (NOT ARG_NAME_PREFIX)
      ...
      if (NOT "${ECM_TEST_NAME_PREFIX}" STREQUAL "${ARG_NAME_PREFIX}")
          message(STATUS "ECM_TEST_NAME_PREFIX DIFF: ${ECM_TEST_NAME_PREFIX} VS ${ARG_NAME_PREFIX}")
      endif()
  endif()
