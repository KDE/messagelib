...
private Q_SLOTS:
    ...
    void expired_data()
    {
        ...
        std::vector<GpgME::Key> keys;
        job->exec(QStringList() << QStringLiteral("EB85BB5FA33A75E15E944E63F231550C4F47E38E"), false, keys);
        QTest::newRow("openpgp")  << keys[0] 
                                  << QStringLiteral("<p>The OpenPGP key for</p><p align=center><b>alice@autocrypt.example</b> (KeyID 0xF231550C4F47E38E)</p><p>expired less than a day ago.</p>")
                                  << QStringLiteral("<p>Your OpenPGP encryption key</p><p align=center><b>alice@autocrypt.example</b> (KeyID 0xF231550C4F47E38E)</p><p>expired less than a day ago.</p>")
                                  << QStringLiteral("<p>Your OpenPGP signing key</p><p align=center><b>alice@autocrypt.example</b> (KeyID 0xF231550C4F47E38E)</p><p>expired less than a day ago.</p>");
        QTest::newRow("smime")  << Test::getKeys(true)[0]
                                << QStringLiteral("<p>The S/MIME certificate for</p><p align=center><b>CN=unittest cert,EMAIL=test@example.com,O=KDAB,C=US</b> (serial number 00D345203A186385C9)</p><p>expired less than a day ago.</p>")
                                << QStringLiteral("<p>Your S/MIME encryption certificate</p><p align=center><b>CN=unittest cert,EMAIL=test@example.com,O=KDAB,C=US</b> (serial number 00D345203A186385C9)</p><p>expired less than a day ago.</p>")
                                << QStringLiteral("<p>Your S/MIME signing certificate</p><p align=center><b>CN=unittest cert,EMAIL=test@example.com,O=KDAB,C=US</b> (serial number 00D345203A186385C9)</p><p>expired less than a day ago.</p>");
    }
    ...
    void nearexpiry_data()
    {
        ...
        job->exec(QStringList() << QStringLiteral("EB85BB5FA33A75E15E944E63F231550C4F47E38E"), false, keys);
        QTest::newRow("openpgp")  << keys[0] 
                                  << QStringLiteral("<p>The OpenPGP key for</p><p align=center><b>alice@autocrypt.example</b> (KeyID 0xF231550C4F47E38E)</p><p>expires in less than 6 days.</p>")
                                  << QStringLiteral("<p>Your OpenPGP encryption key</p><p align=center><b>alice@autocrypt.example</b> (KeyID 0xF231550C4F47E38E)</p><p>expires in less than 6 days.</p>")
                                  << QStringLiteral("<p>Your OpenPGP signing key</p><p align=center><b>alice@autocrypt.example</b> (KeyID 0xF231550C4F47E38E)</p><p>expires in less than 6 days.</p>");
        QTest::newRow("smime")  << Test::getKeys(true)[0]
                                << QStringLiteral("<p>The S/MIME certificate for</p><p align=center><b>CN=unittest cert,EMAIL=test@example.com,O=KDAB,C=US</b> (serial number 00D345203A186385C9);</p><p>expires in less than 6 days.</p>")
                                << QStringLiteral("<p>Your S/MIME encryption certificate</p><p align=center><b>CN=unittest cert,EMAIL=test@example.com,O=KDAB,C=US</b> (serial number 00D345203A186385C9);</p><p>expires in less than 6 days.</p>")
                                << QStringLiteral("<p>Your S/MIME signing certificate</p><p align=center><b>CN=unittest cert,EMAIL=test@example.com,O=KDAB,C=US</b> (serial number 00D345203A186385C9);</p><p>expires in less than 6 days.</p>");
    }
